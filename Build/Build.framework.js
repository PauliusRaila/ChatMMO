...
var ASM_CONSTS = {
  8001768: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 8001823: ($0) => { performance.now = function() { return $0; }; },  
 8001871: ($0) => { performance.now = function() { return $0; }; },  
 8001919: () => { performance.now = Module['emscripten_get_now_backup']; }
};
